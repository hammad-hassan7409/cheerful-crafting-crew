      ...
      <footer className="border-t border-border/40 py-12 bg-card/30">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-4">
            <Button variant="ghost" size="sm" className="text-xs uppercase tracking-widest font-bold flex items-center gap-2 px-4 bg-[#25D366] hover:bg-[#25D366]/80 text-white" asChild>
            ...
            <Button variant="ghost" size="sm" className="text-xs uppercase tracking-widest font-bold flex items-center gap-2 px-4 bg-white hover:bg-white/90 text-black border border-white/20" asChild>
