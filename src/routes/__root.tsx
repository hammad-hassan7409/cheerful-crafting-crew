...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: (options) => {
    const queryClient = (options as any).context?.queryClient as QueryClient | undefined;
    const settings = queryClient?.getQueryData(["settings"]) as Record<string, any> | undefined;
    ...
    return {
      meta: [
        ...
        { name: "twitter:site", content: "@AREditz" },
      ],
      links: [
        {
          rel: "stylesheet",
        ...
        { 
          ...
          type: logoUrl ? (logoUrl.endsWith('.png') ? "image/png" : logoUrl.endsWith('.svg') ? "image/svg+xml" : "image/x-icon") : "image/x-icon" 
        },
      ],
    };
  },
